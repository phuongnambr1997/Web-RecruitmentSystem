...
<link rel="stylesheet"
	href="<c:url value="https://fonts.googleapis.com/css?family=Nunito+Sans:200,300,400,700,900|Roboto+Mono:300,400,500"/>">
<link rel="stylesheet"
	...
	<div class="site-wrap">
			...
			<div class="row align-items-center">
				...
				<div class="col-10 col-xl-10 d-none d-xl-block">
					...
					<ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
						<li><a href="/ViewSeeker/${passCodeUser}">Home</a></li>
		...
		<div class="unit-5 overlay"
			...
			<div class="container text-center">
				<h2 class="mb-0">Job Seeker Information</h2>
			</div>
		</div>
		...
		<div class="container">
			<div class="table-wrapper ">
				...
				<table
					class="table table-striped table-hover table-bordered table-customize table-responsive ">
					<thead>
						<tr>
					...
					<c:forEach var="feedBack" items="${getListFeedBack}">
						<tbody>
							<tr>
