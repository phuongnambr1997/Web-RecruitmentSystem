...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0"><a href="#" class="text-black h2 mb-0">Job<strong>Search</strong></a></h1>
          </div>
          ...
          <div class="col-10 col-xl-10 d-none d-xl-block">
            <nav class="site-navigation text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="/NewJob"><span class="rounded bg-primary py-2 px-3 text-white"><span class="h5 mr-2">+</span> Post a Job</span></a></li>
    ...
    <div class="site-blocks-cover" style="background-image: url(/resources/images/hero_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row row-custom align-items-center">
          <div class="col-md-10">
            <h1 class="mb-2 text-black w-75"><span class="font-weight-bold">Find </span>Your Job on Website</h1>
           ...
           <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
               <div class="job-post-item-header d-flex align-items-center">
                  <img src="https://topdev.vn/files/logos/0f48315459fcad7b3c62e731e8a5c66a.png" class="img-responsive">
                 <h2 class="mr-3 text-black h4">Electronics & Electrical Architecture Manager (Working Location: Hanoi - Local Only)</h2>
                 
               </div>
               <div class="job-post-item-body d-block d-md-flex">
                 <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span> Công Ty TNHH Sản Xuất & Kinh Doanh Vinfast - Thành Viên Của Vingroup</div>
                 <div><span class="fl-bigmug-line-big104"></span> Hà Nội, Bắc Ninh, Bắc Giang</div>
                 
                 <div>&nbsp; <span  class="fl-bigmug-line-nine16"></span></a> 11/2/2019</div>
               </div>
              </div>
  ...
  <script>
    ...
    <script src="<c:url value="/resources/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&libraries=places&callback=initAutocomplete"/>"
        async defer></script>
